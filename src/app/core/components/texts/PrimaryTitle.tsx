...
export default function PrimaryText({
  ...
  return (
    <h1
      className={`font-heading xs:text-[54px] text-[36px] font-bold ${textColor} ${alignLeft ? "text-left" : "md:text-center"} mx-auto xs:leading-[72px]  pb-4 pt-4`} style={{ maxWidth: `${maxWidth}px` }}>
      {titleFirstPart} {""}
